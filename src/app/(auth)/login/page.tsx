...
const CAPABILITIES = [
  {
    ...
    description:
      "Have rich conversations powered by Claude. Get answers backed by real-time web search with inline source citations you can verify.",
  },
  {
    icon: (
      <svg
    ...
    title: "Deep Research",
    description:
      "Search the web, fetch and read full pages, and synthesize findings across multiple sources — all within a single conversation.",
  },
  {
    icon: (
      <svg
  ...
  },
  {
    ...
    description:
      "Create Excel spreadsheets, PowerPoint presentations, Word documents, and PDFs directly in chat. Download them instantly.",
  },
  {
    icon: (
      <svg
  ...
  },
  {
    ...
    description:
      "Upload images, PDFs, and documents. Claude reads, analyzes, and reasons over your files with full context in the conversation.",
  },
  {
    icon: (
      <svg
    ...
    description:
      "Run Python, JavaScript, and shell scripts in a secure server-side sandbox. Perfect for data analysis, math, parsing, and quick prototyping.",
  },
  {
    icon: (
      <svg
    ...
    description:
      "Generate and edit images with Imagen 4 and Gemini models. Create visuals from text prompts, then iterate with follow-up edits in the same conversation.",
  },
  {
    icon: (
      <svg
    ...
    <div className="bg-background text-foreground">
        ...
        <div className="mx-auto max-w-[1080px]">
          <div className="text-center mb-16">
            ...
            <p className="mt-4 mx-auto max-w-[520px] text-[0.92rem] leading-[1.55] text-[rgba(245,240,232,0.45)]">
              Relay AI brings together conversational AI, research tools, code execution, and full development workflows
              — so you never have to context-switch.
            </p>
          </div>
        ...
        <div className="mx-auto max-w-[860px]">
          <div className="text-center mb-16">
            ...
            <p className="mt-4 mx-auto max-w-[480px] text-[0.92rem] leading-[1.55] text-[rgba(245,240,232,0.45)]">
              A main conversational agent handles research and orchestration. When you need code, it delegates to a
              specialized coding agent inside a cloud sandbox.
            </p>
          </div>
      ...
      <section className="px-6 py-28 max-[480px]:py-20 border-t border-[rgba(255,255,255,0.05)]">
        <div className="mx-auto max-w-[480px] text-center">
          ...
          <p className="mt-3 text-[0.9rem] text-[rgba(245,240,232,0.45)]">Sign in to access your AI workspace.</p>
